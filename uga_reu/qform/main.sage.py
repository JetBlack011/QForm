...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8)
import qform
import os
...
while True:
    ...
    # print(f'{cuts}\n')
    random_Q = qform.intersection_form(_sage_const_2 , qform.intersection_data(cuts))
    #print(f'Q =\n{random_Q}')
